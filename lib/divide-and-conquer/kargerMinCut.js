...
* @param {object} arr - an adjacency list where keys are vertex labels and properties are an array of strings.
*   { [vertexLabel]: edges }
...
function kargerMinCut(arr) {
  debugger;
  // Clone arr. This clones both the object itself & array refs.
  const vertices = {};
  Object.keys(arr).forEach(key => {
    vertices[key] = [...arr[key]];
  });
